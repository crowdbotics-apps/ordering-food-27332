"""ordering_food_27332 URL Configuration
...
admin.site.site_header = "Ordering Food"
admin.site.site_title = "Ordering Food Admin Portal"
admin.site.index_title = "Ordering Food Admin"

# swagger
api_info = openapi.Info(
    title="Ordering Food API",
    default_version="v1",
    description="API documentation for Ordering Food App",
)
